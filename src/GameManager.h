...
float lightPos[4] = {-4.0f, 7.0f, -4.0f, 1.0f};
...
public:
    ...
    Flare* flare = new Flare(target->position);
public:
    GameManager() {
    ...
    void processKeys(unsigned char key, int xx, int yy) {
        switch(key) {
            ...
            case 'v':
                ...
                flare->changePosition(target->position);
                break;
            // Increase speed
            case 'i':
            ...
            case 'g': flareEnabled = !flareEnabled; break;
            case 'c':
            ...
            case 'f':
                ...
                break;
            // CameraType
            case '1': selectCamera(CAMERA_PERSPECTIVE_FOLLOW); flare->setEnabled(true); break;
            case '2': selectCamera(CAMERA_PERSPECTIVE_FIXED); flare->setEnabled(false); break;
            case '3': selectCamera(CAMERA_ORTHO); flare->setEnabled(false); break;
        }
    }
    ...
    void initScene() {
        ...
        string particle_text = "textures/crcl.tga";
        ...
        TGA_Texture(FlareTextureArray, "textures/crcl.tga", 0);
        TGA_Texture(FlareTextureArray, "textures/flar.tga", 1);
        TGA_Texture(FlareTextureArray, "textures/hxgn.tga", 2);
        TGA_Texture(FlareTextureArray, "textures/ring.tga", 3);
        TGA_Texture(FlareTextureArray, "textures/sun.tga", 4);
        ...
        flare->loadFlareFile(&AVTflare, "flare.txt");
    }
    ...
    void renderScene() {
        ...
        glBindTexture(GL_TEXTURE_2D, FlareTextureArray[0]);
        ...
        if(flareEnabled){
            flare->render(AVTflare, FlareTextureArray, lPos_uniformId);
        }
