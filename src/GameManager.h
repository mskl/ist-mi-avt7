...
float lightPos[4] = {4.0f, 6.0f, 2.0f, 3.0f}; //position of point light in World coordinates
...
public:
    ...
    void renderScene() {
        ...
        if(spotLight->isEnabled()){
            ...
            //lightPos[0] = player->position.x;
            //lightPos[1] = player->position.y;
            //lightPos[2] = player->position.z;
